...
export default function ZoomIcon({ 
  ...
  return (
    <div className={componentStyles.ZoomIcon}>
      <svg id="Component_13_64"  width="100" height="100" viewBox="0 0 100 100">
        <defs>
        ...
        <g id="Group_1368" data-name="Group 1368" transform="translate(17.75 10.919)" clip-path="url(#clip-path)">
